import { useContext, createContext, prop, Component, computed, provideContext, signal, isBoolean, effect, setAttribute, uppercaseFirstChar, isNil, isString, noop, isFunction, unwrap, camelToKebabCase, onDispose, scoped, keysOf, isArray, tick, peek, isKeyboardClick } from './vidstack-CRlI3Mh7.js';
import { useMediaContext, useMediaState } from './vidstack-Cpte_fRf.js';
import { watchColorScheme, useResizeObserver, useActive } from './vidstack-DWQEfrPg.js';
import { html } from 'lit-html';
import { $signal, LayoutIconsLoader, Icon } from './vidstack-7xep0lg7.js';
import { watchActiveTextTrack } from './vidstack-lwuXewh7.js';
import { $ariaBool, sortVideoQualities } from './vidstack-BOTZD4tC.js';
import { ifDefined } from 'lit-html/directives/if-defined.js';
import { ref } from 'lit-html/directives/ref.js';
import { getDownloadFile, appendParamsToURL } from './vidstack-A9j--j6J.js';
...
class DefaultLayoutIconsLoader extends LayoutIconsLoader {
  async loadIcons() {
    const paths = (await import('./vidstack-H72EDyqs.js')).icons, icons = {};
