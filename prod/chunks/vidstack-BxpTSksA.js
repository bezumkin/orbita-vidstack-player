import { Host, effect, Component, signal, setAttribute, isBoolean, computed, isString, useState } from './vidstack-CRlI3Mh7.js';
import { Captions, Gesture, MediaAnnouncer, Controls, ControlsGroup, GoogleCastButton, ToggleButton, Tooltip, TooltipTrigger, TooltipContent, ChaptersRadioGroup, AudioGainRadioGroup, Radio, RadioGroup, SliderVideo, AudioGainSlider, SpeedSlider, QualitySlider, SliderChapters } from './vidstack-BvKeC8_H.js';
import { useMediaContext } from './vidstack-Cpte_fRf.js';
import { watchCueTextChange } from './vidstack-DE4XvkHU.js';
import { html } from 'lit-html';
import { requestScopedAnimationFrame, isHTMLElement, cloneTemplateContent, createTemplate, cloneTemplate } from './vidstack-Ds_q5BGO.js';
import { LitElement } from './vidstack-CwTj4H1w.js';
import { MenuPortal, Slider, sliderState } from './vidstack-CVCGvr0y.js';
import { renderMenuItemsTemplate } from './vidstack-DFfsZe7-.js';
