import { EventsTarget, DOMEvent, ViewController, InferEventDetail, SetRequired, MaybeStopEffect, Writable, WriteSignal, ReadSignalRecord, Context, Scope, Dispose, State, Store, Component, ReadSignal } from './vidstack-BNOTL9fc.js';
import * as media_captions from 'media-captions';
import { VTTCue, VTTRegion, CaptionsFileFormat, CaptionsParserFactory, VTTHeaderMetadata } from 'media-captions';
...
interface VTTCueInit extends Omit<Partial<VTTCue>, 'startTime' | 'endTime' | 'text'>, Pick<VTTCue, 'startTime' | 'endTime' | 'text'> {
}
...
declare function parseJSONCaptionsFile(json: string | VTTContent, Cue: typeof VTTCue, Region?: typeof VTTRegion): {
    regions: VTTRegion[];
    cues: VTTCue[];
};
